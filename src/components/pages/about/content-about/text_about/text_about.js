    ...
    render(){
        return (
                <div className="container content mt-5 mb-3 ">
                    <Row>
                        <Col sm="6">
                            <p className="font-weight-bolder text-left text-danger h2"> Why Is a Healthy Weight Important? </p>
                        ...
                        <Col sm="6">
                            <p className="font-weight-bolder h2 text-left text-danger"> Who Is The "Healthy Weight" For? </p>
